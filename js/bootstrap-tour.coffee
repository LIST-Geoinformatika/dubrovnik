      ...
      @_options = $.extend
        ...
        template: '<div class="popover" role="tooltip">
          ...
          <div class="popover-navigation">
            <div class="btn-group">
              <button class="btn btn-sm btn-default" data-role="prev">&laquo; Natrag</button>
              <button class="btn btn-sm btn-default" data-role="next">Naprijed &raquo;</button>
              <button class="btn btn-sm btn-default"
                      data-role="pause-resume"
                      data-pause-text="Pause"
                      data-resume-text="Resume">Pause</button>
            </div>
            <button class="btn btn-sm btn-default" data-role="end">Zatvori</button>
          </div>
        </div>'
