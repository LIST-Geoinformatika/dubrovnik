 ...
 * @param 		string		$bbox			Bounding box of geometry 
...
{
# Build SQL SELECT statement and return the geometry as a GeoJSON element in EPSG: 4326
$sql = "SELECT " . pg_escape_string($fields) . ", st_asgeojson(ST_Envelope(ST_transform(" . pg_escape_string($geomfield) . ",$srid))) AS geojson FROM " . pg_escape_string($geotable);
}
